...
export const thesisIntro = {
  ...
  body: [
    ...
    " <b>Countries</b>: pan-African (Kenya, Nigeria, Egypt, South Africa) as primary. And Senegal, DRC, Côte d’Ivoire, Tunisia, Ethiopia and Tanzania as secondary markets."
  ],
};
